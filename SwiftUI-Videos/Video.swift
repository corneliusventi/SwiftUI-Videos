...
struct VideoList {
    static let topTwelve = [
        ...
        Video(imageName: "average-dev", title: "I'm AVERAGE Software Developer", uploadDate: "January 28, 2020"),
        Video(imageName: "child-vc", title: "How to use Child Controllers", uploadDate: "October 1, 2019"),
